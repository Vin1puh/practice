...
export default function Footer() {
    return(
        <footer className="h-[320px] bg-[#212026] flex justify-center items-center">
            <div className='w-7/10 h-7/10 flex flex-col items-center justify-between'>
                <div className='flex items-center justify-between w-full h-[120px]'>
                    ...
                    <div className='h-2/3 w-3/10 flex flex-col items-start justify-between'>
                    ...
                    <div className='h-2/3 w-11/100 flex flex-col items-center justify-between'>
                        <p className='text-gray-500 text-[1.8rem]'>Следите за нами</p>
                        <div className='w-full h-1/2 flex items-center justify-between'>
